...
#prefix <- '../../TreatmentHet/'
source('../../TreatmentHet/functions/causalMatchFNN.R')
source('../../TreatmentHet/functions/standardMatch.R')
d1 <- readRDS(paste0(prefix, 'data/d1.Rds'))
...
```{r echo=FALSE}
d0_lucky <- readRDS(paste0(prefix, 'data/d0_lucky.Rds'))
...
```{r include=FALSE}
d0_unlucky <- readRDS(paste0(prefix, 'data/d0_unlucky.Rds'))
```
